...
from training.preprocessing import preprocess_sentiment_data

# Load dataset
df = pd.read_excel("data/zoom_classification_dataset_final.xlsx")

# Preprocess for sentiment classification
train_texts, val_texts, train_labels, val_labels = preprocess_sentiment_data(df)
